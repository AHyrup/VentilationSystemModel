...
startTime = {"year": 2023, "month": 10, "day": 29, "hour": 3, "minute": 0, "second": 0}
endTime = {"year": 2024, "month": 3, "day": 31, "hour": 0, "minute": 50, "second": 0}
...
model = Model(configFile = configFileName, startTimeInput = startTime, endTimeInput = endTime, 
              ...
              damperControlType = "PD", createBuildingSpacePlots = False, createSystemPlots = True,
