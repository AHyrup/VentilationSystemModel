...
startTime = {"year": 2024, "month": 3, "day": 31, "hour": 3, "minute": 0, "second": 0}
endTime = {"year": 2024, "month": 6, "day": 30, "hour": 23, "minute": 50, "second": 0}
...
model = Model(configFile = configFileName, startTimeInput = startTime, endTimeInput = endTime, 
              ...
              damperControlType = "schedule", createBuildingSpacePlots = False, createSystemPlots = True,
