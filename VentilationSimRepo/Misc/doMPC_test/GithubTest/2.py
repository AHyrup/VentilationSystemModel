...
def template_model(symvar_type='SX'):
    ...
    model.set_variable('_tvp', 'pos_set')
...
fig, ax = plt.subplots(7, sharex=True, figsize=(16,12))
...
mpc_graphics.add_line(var_type='_tvp', var_name='pos_set', axis=ax[6])
